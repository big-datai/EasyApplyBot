        ...
        if len(frm_el) > 0:
            for el in frm_el:
                ...
                try:
                    ...
                    #adding any readio botton questions here
                        ...
                        answer = 'no'
                    #Are you legally authorized to work for any employ
                    elif 'authorized' in radio_text or 'authorised' in radio_text or 'legally' in radio_text:
                        answer = 'yes' #self.get_answer('legallyAuthorized')
                ...
                try:
                    ...
                    if 'proficiency' in question_text:
                        ...
                        if choice == "":
                            choice = options[len(options) - 1]
                        self.select_dropdown(dropdown_field, 'Yes')
